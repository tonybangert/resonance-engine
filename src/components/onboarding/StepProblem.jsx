...
export default function StepProblem() {
  return (
    <div className="flex flex-col items-center justify-center min-h-full text-center px-8 max-w-3xl mx-auto gap-10">
      {/* Overline */}
      <motion.div
        {...fadeSlideUp}
      ...
      <motion.h1
        ...
        className="text-3xl md:text-4xl font-[family-name:var(--font-family-heading)] leading-snug"
      >
      ...
      <motion.div
        ...
        className="bg-brand-surface/50 border border-brand-border/50 rounded-2xl px-12 py-8"
      >
        <AnimatedNumber
          value={15.0}
          decimals={1}
          suffix="%"
          duration={1500}
          className="text-6xl font-mono font-bold text-text-muted/60"
        />
