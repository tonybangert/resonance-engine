...
export default function PipelineView({ consumer, campaign, context, scoring }) {
      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center max-w-lg space-y-8">
          <div className="space-y-3">
            <h2 className="text-3xl font-semibold text-text-primary font-[family-name:var(--font-family-heading)]">
            ...
            {HERO_STAGES.map((stage, i) => (
              ...
              >
                ...
                {i < HERO_STAGES.length - 1 && (
                  <ChevronRight className="w-3 h-3 text-brand-border-light mb-4" />
                )}
              </motion.div>
            ))}
          </div>
          ...
          >
            <div>
              <div className="text-lg font-mono font-bold text-rmt-orange">14.7x</div>
              <div className="text-[10px] text-text-muted">Context Lift</div>
            </div>
            <div className="w-px bg-brand-border" />
            <div>
              <div className="text-lg font-mono font-bold text-combined-gold">0.618</div>
              <div className="text-[10px] text-text-muted">Phi Blend</div>
            </div>
            <div className="w-px bg-brand-border" />
            <div>
              <div className="text-lg font-mono font-bold text-accent-green">R²=.88</div>
              <div className="text-[10px] text-text-muted">Combined Accuracy</div>
            </div>
          </motion.div>
  ...
  return (
    <div className="space-y-0 max-w-2xl mx-auto">
      <div className="mb-4">
        <h2 className="text-lg font-semibold text-text-primary font-[family-name:var(--font-family-heading)]">
          ...
          {index === 3 && animation.isStageVisible(3) && (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2">
                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-rmt-orange/40 to-rmt-orange/60" />
                <div className="text-[10px] text-rmt-orange font-medium uppercase tracking-wider whitespace-nowrap">
                  RMT Science Alone
                </div>
                <div className="px-2 py-0.5 bg-rmt-orange/10 border border-rmt-orange/20 rounded text-[10px] font-mono text-rmt-orange-light whitespace-nowrap">
