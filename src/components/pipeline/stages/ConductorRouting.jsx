  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-2 text-xs">
        <div>
          <span className="text-text-muted">Query x User:</span>
          <span className="ml-1 text-engine-red font-mono">40%</span>
        </div>
        <div>
          <span className="text-text-muted">User x Context:</span>
          <span className="ml-1 text-engine-red font-mono">35%</span>
        </div>
        <div>
          <span className="text-text-muted">Domain fit:</span>
          <span className="ml-1 text-engine-red font-mono">25%</span>
        </div>
      </div>
      ...
      {bestDomainInfo && (
        <div className="flex items-center gap-2">
          <div className="text-xs text-text-muted">Best domain:</div>
